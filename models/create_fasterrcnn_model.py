...
def return_fasterrcnn_resnet18(num_classes, pretrained=True, coco_model=False):
    model = fasterrcnn_resnet18.create_model(num_classes, pretrained, coco_model)
    return model


def return_fasterrcnn_custom_resnet(num_classes, pretrained=True, coco_model=False):
    model = fasterrcnn_custom_resnet.create_model(num_classes, pretrained, coco_model)
    return model


def return_fasterrcnn_darknet(num_classes, pretrained=True, coco_model=False):
    model = fasterrcnn_darknet.create_model(num_classes, pretrained, coco_model)
    return model


def return_fasterrcnn_squeezenet1_0(num_classes, pretrained=True, coco_model=False):
    model = fasterrcnn_squeezenet1_0.create_model(num_classes, pretrained, coco_model)
    return model


def return_fasterrcnn_squeezenet1_1(num_classes, pretrained=True, coco_model=False):
    model = fasterrcnn_squeezenet1_1.create_model(num_classes, pretrained, coco_model)
    return model


def return_fasterrcnn_mini_darknet(num_classes, pretrained=True, coco_model=False):
    model = fasterrcnn_mini_darknet.create_model(num_classes, pretrained, coco_model)
    return model
...
def return_fasterrcnn_efficientnet_b0(num_classes, pretrained=True, coco_model=False):
    model = fasterrcnn_efficientnet_b0.create_model(num_classes, pretrained, coco_model)
    return model


def return_fasterrcnn_nano(num_classes, pretrained=True, coco_model=False):
    model = fasterrcnn_nano.create_model(num_classes, pretrained, coco_model)
    return model


def return_fasterrcnn_resnet152(num_classes, pretrained=True, coco_model=False):
    model = fasterrcnn_resnet152.create_model(num_classes, pretrained, coco_model)
    return model
...
def return_fasterrcnn_convnext_small(num_classes, pretrained=True, coco_model=False):
...
def return_fasterrcnn_convnext_tiny(num_classes, pretrained=True, coco_model=False):
...
def return_fasterrcnn_resnet101(num_classes, pretrained=True, coco_model=False):
...
def return_fasterrcnn_vitdet(num_classes, pretrained=True, coco_model=False):
...
def return_fasterrcnn_vitdet_tiny(num_classes, pretrained=True, coco_model=False):
...
def return_fasterrcnn_mobilevit_xxs(num_classes, pretrained=True, coco_model=False):
...
def return_fasterrcnn_regnet_y_400mf(num_classes, pretrained=True, coco_model=False):
...
def return_fasterrcnn_vgg16(num_classes, pretrained=True, coco_model=False):
...
create_model = {
    ...
    "retinanet_resnet50_fpn": return_retinanet_resnet50_fpn
}
